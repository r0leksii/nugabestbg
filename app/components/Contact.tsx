    ...
    <section id="contact" className="relative bg-white py-16 sm:py-20 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative bg-white shadow-xl">
          <h2 className="sr-only">Свържете се с нас</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden py-10 px-6 bg-blue-700 sm:px-10 xl:p-12">
              ...
              <div className="relative">
                <h3 className="text-lg font-medium text-white">Контактна информация</h3>
                <p className="mt-6 text-base text-blue-50 max-w-3xl">
                  Свържете се с нас за безплатна демонстрация или допълнителна информация 
                  относно Nuga Best N6.
                </p>
                <dl className="mt-8 space-y-6">
                  ...
                  <dd className="flex text-base text-blue-50">
                    ...
                    <span className="ml-3">ул. "Андрей Сахаров" 11, Младост 1, София</span>
                  </dd>
                  <dt>
                  ...
                  <dd className="flex text-base text-blue-50">
                    ...
                    <span className="ml-3">+359 888 123 456</span>
                  </dd>
                  <dt>
                  ...
                  <dd className="flex text-base text-blue-50">
                    ...
                    <span className="ml-3">contact@nugabest.bg</span>
                  </dd>
                </dl>
            ...
            <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
              <h3 className="text-lg font-medium text-gray-900">Изпратете запитване</h3>
